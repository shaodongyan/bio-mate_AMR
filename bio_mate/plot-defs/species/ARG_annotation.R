...
tryCatch({
  ...
  # 打印start列的摘要
  message("Summary of start column in tempVar: \n", summary(tempVar$start))
  ...
  # 计算n()的值
  n_val = nrow(tempVar2)
  message("Number of rows in tempVar2: ", n_val)

  tempVar2 = tempVar2 %>% 
          mutate(startGroup = 1:n_val) %>% 
...
tryCatch({
  ...
  # 打印startGroup列的值
  message("tempVar2 before pivot_wider: \n", toString((tempVar2)))
